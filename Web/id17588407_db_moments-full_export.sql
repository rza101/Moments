...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2022 at 02:33 PM
...
--
-- Database: `id17588407_db_moments`
--
...
(14, '2022_12_14_092405_create_posts_table', 1),
(15, '2022_12_14_092449_create_post_likes_table', 1),
(16, '2022_12_14_092553_create_post_comments_table', 1),
(17, '2022_12_14_092615_create_saved_posts_table', 1),
(18, '2022_12_18_071742_create_user_follow', 1);
...
CREATE TABLE `user_follow` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_following` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `user_follow`
  ...
  ADD KEY `user_follow_user_following_foreign` (`user_following`);
...
ALTER TABLE `saved_posts`
  ...
  ADD CONSTRAINT `saved_posts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;

--
-- Constraints for table `user_follow`
--
ALTER TABLE `user_follow`
  ADD CONSTRAINT `user_follow_user_following_foreign` FOREIGN KEY (`user_following`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `user_follow_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
COMMIT;
